...
import { getYouTubeThumbnailUrl, formatDuration } from "@/lib/utils";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {videos.map((video) => (
              <Link
                ...
                className="bg-card rounded-lg shadow-sm border border-border overflow-hidden hover:shadow-md transition-shadow group focus:outline-none focus:ring-2 focus:ring-primary"
                aria-label={`Open video ${video.name}`}
              >
                {/* Video Thumbnail */}
                <div className="relative aspect-video bg-gray-100 dark:bg-gray-800">
                  <Image
                    src={getYouTubeThumbnailUrl(video.youtubeId, "medium")}
                  ...
                  <div className="absolute top-2 right-2 w-10 h-10 bg-white/70 dark:bg-black/50 rounded-full flex items-center justify-center shadow-sm">
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-card-foreground group-hover:text-foreground line-clamp-2 mb-2">
                        {video.name}
                      </h3>
